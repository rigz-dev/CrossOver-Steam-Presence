...
Detects whether CrossOver is running, fetches the Steam user's current game, updates Discord activity.
...
Get Steam UserID
  ...
  4. Your 17-digit SteamID64 is located under your account name.
